...
describe('Login Tests', function() {
  ...
  it('Verify that the user is not able to access the app with an invalid login credential (Password)', function() {
    loginPage.navigate('https://biskit-frontend-dev.eha.im/#/signin');
    loginPage.enterusername('nelo_processing');
  ...
  it('Verify that the user is not able to access the app with an invalid login credential (Username)', function() {
    loginPage.navigate('https://biskit-frontend-dev.eha.im/#/signin');
    loginPage.enterusername('nelo_processing123');
...
describe('Landing page', function() {
  ...
  it('Verify that the user is able to view the profile details of the logged in user on the landing page', function() {
    ...
    loginPage.clickLogin();
    // cy.wait(10000)
    cy.get('[data-testid="user-info-nelo_processing"]')
    .should('be.visible')
  })
...
describe('Report menu', function() {
  ...
  describe("processing", function () {
    it('Verify that the user is able to view and click on the "processing" sub-menu button', function () {
      loginPage.navigate("https://biskit-frontend-dev.eha.im/#/signin");
      loginPage.enterusername("nelo_processing");
      loginPage.enterPassword("password");
      loginPage.clickLogin();
    ...
    it('Verify that the "processing" page title contains processing as a title text', function () {
      loginPage.navigate("https://biskit-frontend-dev.eha.im/#/signin");
      loginPage.enterusername("nelo_processing");
      loginPage.enterPassword("password");
      loginPage.clickLogin();
    ...
    it("Verify that the processing landing page contains a table with columns namely; donor code, blood product, volume, facility and action", function () {
      loginPage.navigate("https://biskit-frontend-dev.eha.im/#/signin");
      loginPage.enterusername("nelo_processing");
      loginPage.enterPassword("password");
      loginPage.clickLogin();
    ...
    it('Verify that the processing landing page has search field with a place holder "Search processing Records"', function () {
      loginPage.navigate("https://biskit-frontend-dev.eha.im/#/signin");
      loginPage.enterusername("nelo_processing");
      loginPage.enterPassword("password");
      loginPage.clickLogin();
    ...
    it("Verify that the user is able to search processing by patient code and that the result is clearly visible", function () {
      loginPage.navigate("https://biskit-frontend-dev.eha.im/#/signin");
      loginPage.enterusername("nelo_processing");
      loginPage.enterPassword("password");
      loginPage.clickLogin();
      ...
      cy.contains("Reports").click();
      cy.contains("Processing").click();
      cy.get(".sc-fnykZs").type("EFA");
      cy.get('[aria-rowindex="2"] > .rs-table-cell-group > .rs-table-cell-first > .rs-table-cell-content')
      .should("be.visible");
    });
    it("Verify that the user is able to search processing by blood product and that the result is clearly visible", function () {
      loginPage.navigate("https://biskit-frontend-dev.eha.im/#/signin");
      loginPage.enterusername("nelo_processing");
      loginPage.enterPassword("password");
      loginPage.clickLogin();
      ...
      cy.get('[aria-rowindex="3"] > .rs-table-cell-group > [aria-colindex="2"] > .rs-table-cell-content')
      .should("be.visible");
    });
    it("Verify that the user is able to search processing by Volume and that the result is clearly visible", function () {
      loginPage.navigate("https://biskit-frontend-dev.eha.im/#/signin");
      loginPage.enterusername("nelo_processing");
      loginPage.enterPassword("password");
      loginPage.clickLogin();
      ...
      cy.contains("Reports").click();
      cy.contains("Processing").click();
      cy.get(".sc-fnykZs").type("20");
      cy.get('[aria-rowindex="2"] > .rs-table-cell-group > [aria-colindex="3"] > .rs-table-cell-content')
      .should("be.visible");
    });
   
    it("Verify that the user is able to search processing by facility and that the result is clearly visible", function () {
      loginPage.navigate("https://biskit-frontend-dev.eha.im/#/signin");
      loginPage.enterusername("nelo_processing");
      loginPage.enterPassword("password");
      loginPage.clickLogin();
    ...
    it('Verify that when the user clicks on "View details" the system pops up a modal with title "processing Report Information" ', function () {
      loginPage.navigate("https://biskit-frontend-dev.eha.im/#/signin");
      loginPage.enterusername("nelo_processing");
      loginPage.enterPassword("password");
      loginPage.clickLogin();
      ...
      cy.contains("View details").click();
      cy.get(".sc-ivTmOn").should("contain", "Processing Result Information");
    });
    it("Verify that the modal contains details under processing information,blood product derived, health worker information, equipment & consumables and  other information details", function () {
      loginPage.navigate("https://biskit-frontend-dev.eha.im/#/signin");
      loginPage.enterusername("nelo_processing");
      loginPage.enterPassword("password");
      loginPage.clickLogin();
      ...
      .should('have.text','Processing Information')
      .and('be.visible')
      cy.contains('Blood Product Derived')
      .should('have.text','Blood Product Derived')
      .and('be.visible')
      cy.contains('Health Worker Information').scrollIntoView()
      .should('have.text','Health Worker Information')
      .and('be.visible')
      cy.contains('Equipment & Consumables').scrollIntoView()
      .should('have.text','Equipment & Consumables')
      .and('be.visible')
      cy.contains('Other Information').scrollIntoView()
      .should('have.text','Other Information')
      .and('be.visible')
        .should("have.text", "Other Information")
        .and("be.visible");
    ...
    it("Verify that the total number of records available is displayed on top and bottom of the processing page", function () {
      loginPage.navigate("https://biskit-frontend-dev.eha.im/#/signin");
      loginPage.enterusername("nelo_processing");
      loginPage.enterPassword("password");
      loginPage.clickLogin();
    ...
    it("Verify that the processing page is paginated", function () {
      loginPage.navigate("https://biskit-frontend-dev.eha.im/#/signin");
      loginPage.enterusername("nelo_processing");
      loginPage.enterPassword("password");
      loginPage.clickLogin();
    ...
    it("Verify that the user is able to filter by facility", function () {
      ...
      cy.contains("Processing").click();
      cy.get(".rs-flex-box-grid-item > .sc-bczRLJ").click();
      cy.get(':nth-child(1) > .sc-jdAMXn > .sc-idiyUo > .rs-picker-toggle > .rs-stack > [style="flex-grow: 1; overflow: hidden;"]').click()
      cy.wait(10000)
      cy.get(':nth-child(1) > .sc-jdAMXn > .sc-idiyUo > .rs-picker-toggle > .rs-stack > [style="flex-grow: 1; overflow: hidden;"]').click()
      cy.contains('Lagos State University Teaching Hospital (LASUTH)').click()
      cy.get('[style="margin-top: 24px;"] > .sc-bczRLJ').click()
  
    });
    it("Verify that the user is able to filter by blood product type", function () {
      loginPage.navigate("https://biskit-frontend-dev.eha.im/#/signin");
      loginPage.enterusername("nelo_processing");
      loginPage.enterPassword("password");
      loginPage.clickLogin();
      ...
      cy.contains("Processing").click();
      cy.get('.rs-flex-box-grid-item > .sc-bczRLJ').click()
      cy.get(':nth-child(2) > .sc-jdAMXn > .sc-idiyUo > .rs-picker-toggle > .rs-stack > [style="flex-grow: 1; overflow: hidden;"]').click()
      cy.contains('PLATELETS').click()
      cy.get('[style="margin-top: 24px;"] > .sc-bczRLJ').click()  
    });
  
    
    it.only("Verify that the user is able to filter by date period", function () {
      loginPage.navigate("https://biskit-frontend-dev.eha.im/#/signin");
      loginPage.enterusername("nelo_processing");
      loginPage.enterPassword("password");
      loginPage.clickLogin();
      ...
      cy.wait(10000)
      cy.get('.sc-hAZoDl > .rs-picker-toggle > .rs-stack > [style="flex-grow: 1; overflow: hidden;"] > .rs-picker-toggle-textbox').type('2022-12-21 ~ 2023-01-24')
